            ...
            <div class="card__giratorio-conteudo">
                ...
                <div class="card__giratorio-conteudo--traseira">
                    ...
                    <table class="table table-primary table-striped">
                        ...
                        $sql = "SELECT DISTINCT E.nombre, P.P_jug, P.P_gan, P.P_emp, P.P_per, P.G_fav, P.G_con, P.Dif_G, P.puntaje FROM posiciones P, equipos E WHERE E.id_equipo = P.id_equipo ORDER BY P.puntaje DESC, P.Dif_G DESC, P.G_fav";
